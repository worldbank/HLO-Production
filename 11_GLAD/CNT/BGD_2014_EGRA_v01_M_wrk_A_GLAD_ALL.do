...
set sortseed 10051990
    ...
    *<_score_assessment_subject_pv_> *Variable comptotals values are not correct in the data.
	egen score_egra_read_sum = rowtotal(comp? comp??)
	gen score_egra_read = (score_egra_read_sum/10)*100
