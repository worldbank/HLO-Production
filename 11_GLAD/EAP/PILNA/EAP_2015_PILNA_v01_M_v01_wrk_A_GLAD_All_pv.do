...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    *Appending Literacy files:
	   ...
	   *Currently the file for maths does not have scaled scores available
	   foreach file in LIT_2015_Y4Y6_FINAL_COMBINED {
    ...
    *---------------------------------------------------------------------------
	 ...
	 */  
       ...
       use "`temp_dir'/LIT_2015_Y4Y6_FINAL_COMBINED", clear
    ...
    *<_idcntry_raw_>
    clonevar idcntry_raw = countrydesc
    ...
    *<_idlearner_>
	format newcandidateid %18.0g
    clonevar idlearner = newcandidateid
...
*/
    ...
    *<_score_assessment_subject_pv_> 
    foreach pv in 1 2 3 4 5 {
      gen score_pilna_read_`pv' = ss_pv`pv'_d1
    ...
    *<_level_assessment_subject_pv_> - Levels not available
    foreach pv in 1 2 3 4 5 {
      gen level_pilna_read_`pv' = pl_pv`pv'_d1
    ...
    *</_level_assessment_subject_pv_>*/
    ...
    // TRAIT Vars:
    local traitvars	"age urban* male"
    ...
    *<_urban_> 
    gen byte urban = 1 if locality == 0 
	replace urban = 0 if inlist(locality,1,2,3)
    ...
    *<_male_>
    gen byte male = 1 if genderdesc == "Male"
	replace male = 0 if genderdesc == "Female"
