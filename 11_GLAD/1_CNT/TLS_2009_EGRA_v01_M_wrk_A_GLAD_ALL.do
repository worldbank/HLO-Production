...
local dofile_info = "last modified Domenica Avila 22.1.2022"  /* change date*/
*
* Steps:
...
set sortseed 10051990
    ...
    *<_score_assessment_subject_pv_>
	...
	gen score_egra_read_zero=(score_egra_read==0)
	replace score_egra_read_zero=. if score_egra_read==.
	label var score_egra_read_zero "Scored zero in all reading comprehension questions for `assessment' "
    *}
    *</_score_assessment_subject_pv_>
    ...
    *</_idclass_>*/
    ...
    local samplevars "learner_weight su1 su2 strata2 national_level nationally_representative regionally_representative"
