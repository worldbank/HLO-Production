...
*==============================================================================*
  ...
  * Aroob
  if inlist("`c(username)'","wb504672","WB504672") {
    global clone "N:\GDB\Personal\WB504672\WorldBank_Github\MHC-HLO-Production2\MHC-HLO-Production\11_GLAD"
  }
  ...
  * Load project specific ado-files
  ...
  net install glad_toolkit.pkg, from("${clone}/01_adofiles") replace
...
global output "${clone}/113_outputs"  // Where GLAD.dta files will be saved
display "${clone}"
