...
set sortseed 10051990
    ...
    *<_score_assessment_subject_pv_>
	...
	replace a2q1 ="." if a2q1=="3" | a2q1=="notAsked" 
	replace a2q2="." if a2q2=="3" | a2q2=="notAsked" 
	replace a2q3="." if a2q3=="3" | a2q3=="notAsked" 
	replace a2q4="." if a2q4=="3" | a2q4=="notAsked" 
	replace a2q5="." if a2q5=="3" | a2q5=="notAsked" 
	
	destring a2q*, replace
	
	egen read_comp_score_sum = rowtotal(a2q1 a2q2 a2q3 a2q4 a2q5)
	gen read_comp_score_pcnt=read_comp_score_sum/5*100
