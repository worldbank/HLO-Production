...
set sortseed 10051990
    ...
    *<_idlearner_>
	encode id, gen (idlearner) /* check variable id because some observations have codes in letters and others in numbers, all string format*/
    label var idlearner "Learner ID"
    *</_idlearner_>

    /* Drop any value labels of idvars, to be okay to append multiple surveys
    foreach var of local idvars {
      drop label values `var' .
    }*/
