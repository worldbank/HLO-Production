...
set sortseed 10051990
    ...
    *<_score_assessment_subject_pv_> Report - 5 questions are asked of grade 2 and 9 questions are asked of grade 3 students.
	egen read_comp_score = rowtotal(read_comp?)
	gen score_egra_read= (read_comp_score/5)*100 if missing(read_comp6) 
	replace score_egra_read= (read_comp_score/9)*100 
	...
	*<_idgrade_> - From report 
	gen idgrade = 2 /*if missing(read_comp6) */
	*replace idgrade = 3 if !missing(read_comp6) 
