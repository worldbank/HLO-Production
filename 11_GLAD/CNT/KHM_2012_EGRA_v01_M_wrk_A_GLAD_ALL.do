...
local dofile_info = "last modified by Domenica Avila 20.1.2022"  /* change date*/
*
* Steps:
...
set sortseed 10051990
    ...
    foreach file in `list' {
		 ...
		 *cleaning taken from the All do file
		 noisily drop if grade==9  	// Observations that don't match documentation (grades 1-6)
	...
	*<_year_>
	gen year = "`year'"
	label var year "Year"
	tostring year, replace /*applicable if year created is numeric*/
