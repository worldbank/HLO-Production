...
local region      = "LCA" // Rwanda *Make a change here:
local year        = "2018" // Specify the year here
...
*Open the file:
use   "M:\CNT\LCA\LCA_2018_EGRA\LCA_2018_EGRA_v01_M\Data\Stata\SLU_2018_EGRA.dta", clear
		...
		*<_idgrade_> This is stated in the report
		gen idgrade = 2
		*</_idgrade_>
...
* <_read_comp_score_pcnt_>
		...
		*</_age_>
		...
		// VALUE Vars: bo di vi khong co bien
		local valuevars	"score_egra* level_egra* hpro_read"

		*<_score_assessment_subject_pv_> co can bo di khong?
...
save "M:\CNT\LCA\LCA_2018_EGRA\LCA_2018_EGRA_v01_M_wrk_HAD/LCA_2018_EGRA_v01_M_wrk_A_HAD.dta", replace
