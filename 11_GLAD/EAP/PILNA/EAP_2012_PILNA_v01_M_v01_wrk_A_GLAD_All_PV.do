...
*=========================================================================*
  ...
  *if (_rc == 601) | (`overwrite_files') {
    ...
    *Appending files:
       // Temporary copies of the plausible value datasets needed for each file:
	   foreach file in P12_Lit_WB4 P12_Lit_WB6 {
    ...
    *---------------------------------------------------------------------------
	 ...
	 */  
       ...
       use "`temp_dir'/P12_Lit_WB4.dta", clear
	   append using "`temp_dir'/P12_Lit_WB6.dta"
    ...
    *<_idcntry_raw_>
    clonevar idcntry_raw = countryid
    ...
    *<_idlearner_>
    gen long idlearner = newcandidateid
...
*/
	...
	*/
	/*set trace on
	display "`valuevars'"
	keep `idvars' `keyvars' `valuevars' `traitvars' `samplevars'
