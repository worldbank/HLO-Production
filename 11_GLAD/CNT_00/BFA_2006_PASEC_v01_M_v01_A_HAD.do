...
/*
*This do file 
1) Develops harmonized assessment database for BFA_2006_PASEC
*/

global path = "N:\GDB\HLO_Database"

use "${path}\CNT\BFA\BFA_2006_PASEC\BFA_2006_PASEC_v01_M\Data\Stata\BFA2.dta", clear
ren (qe2* qm2*) (qe5* qm5*)
append using "${path}\CNT\BFA\BFA_2006_PASEC\BFA_2006_PASEC_v01_M\Data\Stata\BFA5.dta"
ren (qe5* qm5*) (qe* qm*)
...
foreach var of varlist qe_3a qe_3b qe_3c qe_4a qe_4b qe_4c qe_4d qe_4e qe_4f qe_5a qe_5b qe_5c qe_5d qe_5e qe_5f qe_5g qe_5h qe_6a qe_6b qe_6c {
	bysort numecole numclasse: egen `var'_mean  = mean(`var')
	bysort numstrate numclasse: egen `var'_mean_str = mean(`var')
	
	replace `var' = `var'_mean if missing(`var')
	replace `var' = `var'_mean_str if missing(`var')
}
bysort idgrade: mdesc qe_3a qe_3b qe_3c qe_4a qe_4b qe_4c qe_4d qe_4e qe_4f qe_5a qe_5b qe_5c qe_5d qe_5e qe_5f qe_5g qe_5h qe_6a qe_6b qe_6c
alphawgt qe_3a qe_3b qe_3c qe_4a qe_4b qe_4c qe_4d qe_4e qe_4f qe_5a qe_5b qe_5c qe_5d qe_5e qe_5f qe_5g qe_5h qe_6a qe_6b qe_6c [weight = weight], detail std item // 0.8164

gen house_hard_yn = qe_3a
gen house_semi_hard_yn = qe_3b 
...
gen car_yn = qe_6c
save "${path}\CNT\BFA\BFA_2006_PASEC\BFA_2006_PASEC_v01_M_v01_A_BASE.dta", replace
keep idschool idclass idgrade idstud  female age weight score_reading score_math *_yn
save "${path}\CNT\BFA\BFA_2006_PASEC\BFA_2006_PASEC_v01_M_v01_A_HAD.dta", replace
