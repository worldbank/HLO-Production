...
local dofile_info = "last modified by Domenica Avila 19.1.2022"  /* change date*/
*
* Steps:
...
set sortseed 10051990
   ...
   *<_idschool_> 
    ...
    *</_level_assessment_subject_pv_>*/
    ...
    // TRAIT Vars:
    local traitvars	"male age idgrade total escs"
    ...
    *</_male_>
    ...
    local samplevars "learner_weight fpc1 fpc2 fpc3 strata1 strata2 strata3 su1 su2 su3 national_level nationally_representative regionally_representative"
...
alphawgt s30_1_std s30_2_std s30_3_std s30_4_std s30_5_std s30_6_std s30_7_std s30_8_std s39_d*_std s40_d*_std s41_d*_std [weight = learner_weight], detail item gen(HOMEPOS)
pca s30_1_std s30_2_std s30_3_std s30_4_std s30_5_std s30_6_std s30_7_std s30_8_std s39_d*_std s40_d*_std s41_d*_std [weight = learner_weight]
predict escs
