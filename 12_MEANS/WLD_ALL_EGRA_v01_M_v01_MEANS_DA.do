*****************************************************
*Author: Domenica Avila
******************************************************

/*
This do file:
1) Append all EGRA GLADs
2) Scale all EGRA datasets to have a mean of 500 and a standard deviation of 100 /*This requirement was not mentioned in the meeting so I wont do it to avoid damaging the data. */
...
cap log using "$means\120_documentation\EGRAs.smcl", replace   

use "${clone}\01_input\masterdata.dta", clear

levelsof wbcode, local(ccc)


touch "${temp}\WLD_ALL_EGRA_v01_M_v01_A_GLAD_DA.dta", replace

use "${temp}\WLD_ALL_EGRA_v01_M_v01_A_GLAD_DA.dta", clear
...
save "${temp}\WLD_ALL_EGRA_v01_M_v01_A_GLAD_DA.dta", replace
log close
