...
set sortseed 10051990
	 ...
	 *According to Shahana with UNICEF Bangladesh, the observations for which class is missing are not real data - Only applies to RCT
    ...
    *<_score_assessment_subject_pv_>
	egen read_comp_score_sum = rowtotal(comp? comp??) /*add until comp10*/
	...
	*<_idgrade_> - From report
	clonevar idgrade = grade /*Standarize class denomination across dta in Stata folder.*/
	replace idgrade  = class if grade==. /*Check class or _class?*/
	replace idgrade  = _class if idgrade==.
